...
trait  SmsGateway
{
    ...
    public static function two_factor($receiver, $otp): string
    {
        ...
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
            if(str_starts_with($receiver,"+200")){
                $receiver = str_replace("+200","+20",$receiver);
            }
            $message = [
                "secret" => "8f86a82a3c1693c1a197fb3cde221407212bb70c", // your API secret from (Tools -> API Keys) page
                "type" => "sms",
                "mode" => "devices",
                "device" => "00000000-0000-0000-4e53-279cec6a5ec1",
                "sim" => 1,
                "phone" => $receiver,
                "message" => "Your OTP is ". $otp
            ];
            $cURL = curl_init("https://sms.onclick-eg.com/api/send/otp");
