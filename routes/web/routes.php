...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode','guestCheck']], function () {
    ...
    Route::get('my-products', 'UserProfileController@my_products')->name('account-my-products')->middleware('customer');
    Route::get('my-products-categories', 'UserProfileController@getCategories')->name('account-get_categories')->middleware('customer');

    Route::get('my-products-create', 'UserProfileController@my_products_create')->name('account-products-create')->middleware('customer');
      Route::post('my-products-store', 'UserProfileController@my_products_store')->name('account-products-store')->middleware('customer');
      Route::get('my-products-delete/{id}', 'UserProfileController@delete')->name('account-products-delete')->middleware('customer');
