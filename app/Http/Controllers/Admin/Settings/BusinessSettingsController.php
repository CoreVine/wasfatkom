...
class BusinessSettingsController extends BaseController
{
    ...
    public function getProductSettingsView(): View
    {
        ...
        $taxGeneral = $this->businessSettingRepo->getFirstWhere(params: ['type'=>'tax_general']);

        return view(BusinessSettings::PRODUCT_SETTINGS[VIEW], compact('digitalProduct', 'brand', 'stockLimit','taxGeneral'));
    }
    ...
    public function updateProductSettings(Request $request): RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type: 'tax_general', value: $request->get('tax', 0));
