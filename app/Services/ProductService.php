...
class ProductService
{
    ...
    public function getAddProductData(object $request, string $addedBy, $client_id=null): array
    {
        ...
        if($client_id==null && $addedBy == 'admin'){
            $user_id=auth('admin')->id();
            $status='admin';
        }elseif($client_id!=null && $addedBy == 'admin'){
            $user_id=1;
            $status='user';
        ...
        return [
            ...
            'status' => $status=='admin' ? 1 : 0,
            'request_status' =>$status='admin' ? 1 : (getWebConfig(name: 'new_product_approval') == 1 ? 0 : 1),
