            ...
            <div class="card">
                <div class="p-3 p-sm-4">
                    <div class="d-flex flex-wrap justify-content-between gap-3 mb-3 mb-sm-4">
                        <h2><span class="text-primary">{{translate('Best')}}</span> {{translate('stores')}}</h2>
                        <a href="{{route('vendors')}}" class="btn-link">{{translate('view_all')}}<i class="bi bi-chevron-right text-primary"></i></a>
                    </div>
                            ...
                            <div class="table-responsive hide-scrollbar">
                                <div class="d-flex gap-3 {{count($more_seller) > 2 ? 'justify-content-between' : ''}} store-list">
                                    ...
                                    @foreach($more_seller as $seller)
                                        ...
                                        class="store-product d-flex flex-column gap-3 align-items-center bg-primary-light rounded p-3">
