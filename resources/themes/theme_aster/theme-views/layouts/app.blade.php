...
<head>
    ...
    <link rel="stylesheet" href="{{ theme_asset('assets/css/bootstrap.min.css') }}?v=1.1"/>
    ...
    <link rel="stylesheet" href="{{ theme_asset('assets/css/style.css') }}?v=1.6"/>
    @stack('css_or_js')
    <link rel="stylesheet" href="{{ theme_asset('assets/css/custom.css') }}?v=1.2"/>
<style>
