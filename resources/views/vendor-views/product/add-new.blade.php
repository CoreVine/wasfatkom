...
<style>
    ...
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('vendor.products.add') }}"
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div hidden class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div hidden class="col-md-6 col-lg-4 col-xl-3" id="minimum_order_qty">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
            ...
            <div hidden class=" card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        <h4 class="mb-0">
    ...
    <div class="box" style="display: none;"><div class="loader-04"></div></div>
